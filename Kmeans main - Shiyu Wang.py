...
# Visualize all images when n_clusters= 2, 6, 10
functions.visualize_all(X_all, 6)
# Visualize a single image when n_clusters= 5
functions.visualize_single(X_all[3], 10)
...
# Visualize the top 3 results (4, 3, 6)
...
binary_seg, auc, vessel_clusters = functions.direction_enhanced_kmeans(X_all[3], Y_all[3], 10, 5)
